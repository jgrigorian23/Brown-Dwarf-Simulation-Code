...
"Returns inverse CDF value for a single random input between 0 and 1, called 'x'. Also takes in alpha, the power in the simple power law, m2, which is the given "
...
#SAUMON MARLEY 2018
def get_sm2018():
    file=open("hybrid_solar_mass2018.txt")
    ages=[]
    masses=[]
    temperatures=[]
    lines=file.readlines()
